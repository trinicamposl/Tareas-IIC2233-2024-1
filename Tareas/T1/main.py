...
if existe:
    metro.cambiar_planos(archivo)
    if estacion in metro.estaciones:
        print ('{:^40}'.format(f"Se cargó la red {nombres[1]}"))
        print('{:^40}'.format(f"Escogiste la estación: {nombres[2]}"))
        imprimir_menu()
        opcion = input()
        while opcion != 4 or opcion != "4":
            if opcion.isnumeric():
                if int(opcion) == 1:
                    ...
                    print ('{:<40}'.format("*********************************"))
                    print ('{:^40}'.format(f"La red actual es {nombres[1]}"))
                    print('{:^40}'.format(f"Escogiste la estación: {nombres[2]}"))
                    imprimir_menu()
                    opcion = input()
